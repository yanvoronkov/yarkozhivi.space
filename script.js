...
const quizData = {
	blocks: [
		{
			title: "Отверженность",
			questions: ["Я опасаюсь, что близкие уйдут из моей жизни.", "Мне трудно надеяться — это кажется наивным.", "Я очень тоскую, когда близкого человека нет рядом.", "Я постоянно влюбляюсь в людей, не способных на серьезные отношения.", "Я часто беспокоюсь, что люди, которых я люблю, найдут кого-то, кто им больше понравится, и бросят меня.", "Я фактически росла без родителя (умер или отсутствовал физически).", "Я слишком сильно нуждаюсь в других людях, чтобы со мной были рядом.", "Я так боюсь, что люди бросят меня, что своими действиями отталкиваю их.", "Я впадаю в отчаяние, когда кто-то, кого я люблю, отдаляется от меня.", "В конце концов я останусь в одиночестве."]
		},
		{
			title: "Недоверчивость",
			questions: ["Мне нужно защищать себя самой и всегда быть начеку.", "Близкие люди несколько раз меня предавали, унижали или глубоко оскорбляли.", "Если я не буду осторожнее, люди станут использовать меня в своих интересах.", "Пройдет какое-то время, и люди, которых я люблю, все равно предадут меня.", "Я боюсь подпускать людей близко, потому что не хочу, чтобы мне причинили боль.", "Я стараюсь обидеть людей до того, как они ранят меня.", "Я часто сомневаюсь в мотивах действий других людей.", "Я ожидаю, что люди обидят или используют меня.", "Я злюсь, когда думаю о том, как плохо со мной обращались.", "Я подвергалась физическому, эмоциональному или сексуальному насилию от тех, кто должен был заботиться обо мне."]
		},
		{
			title: "Несостоятельность",
			questions: ["У меня нет «достаточно весомых» достижений.", "Я сдаюсь раньше времени.", "Я малого достигла, и мне стыдно за это.", "Большинство других людей талантливее меня, например в семейной жизни, работе и учебе.", "Я не достаточно компетентна, как большинство людей в моей профессиональной области.", "Меня задевает, что большинство людей достигает лучших результатов в работе, чем я.", "У меня часто нет сил приниматься за свои цели, я саботирую действовать.", "Я испытываю разочарование от своих неудач.", "Я недовольна текущими результатами и считаю, что способна на большее.", "Я боюсь, что у меня снова ничего не получится."]
		},
		{
			title: "Самопожертвование",
			questions: ["Мои отношения страдают из-за того, что я так много работаю.", "Моё здоровье страдает из-за того, что я уделяю работе слишком много времени.", "Я чувствую себя виноватой, когда расстраиваю других людей.", "Я испытываю чувство вины, если ставлю в приоритет свои нужды.", "Я именно та, кто заботится о своих близких больше всех.", "Я хороший человек, потому что думаю о других больше, чем о себе.", "Вне зависимости от уровня занятости, я всегда нахожу время для других людей.", "Я умею обходиться малым.", "Мне сложно принять заботу — я сразу думаю, чем «отплатить».", "Мне приятнее дарить, чем принимать подарки."]
		},
		{
			title: "Отчужденность",
			questions: ["Мне кажется, что я не вписываюсь в большинство коллективов.", "Моя семья отличалась от других семей (статусом, национальностью, внешностью, интеллектуально).", "Люди редко принимают меня за свою.", "Мне некомфортно на вечеринках и хочется поскорей уйти.", "Я чувствую, что живу не своей жизнью.", "Я предпочитаю избегать мероприятий и дел, которые требуют общения с людьми.", "Те, кого я хочу видеть своими друзьями, превосходят меня (статусом, внешностью, интеллектуально).", "Я ощущаю себя никому не нужной, меня нигде не ждут и никуда не зовут.", "Я чувствую себя хуже других, непривлекательной, слишком полной/худой, высокой/низкой, не стильной т. д.", "Я завидую людям, кто ясно знает, что им нужно, а я в поиске себя."]
		},
		{
			title: "Недисциплинированность",
			questions: ["Мне сложно доводить начатое до конца.", "Я часто делаю то, что хочется «прямо сейчас», вместо того что нужно.", "У меня срывы — в еде, покупках, эмоциях.", "Я не люблю рамки и правила.", "Я легко отказываюсь от плана, если становится трудно.", "Я быстро устаю и бросаю.", "Я часто сожалею о спонтанных решениях.", "Я не умею себя организовать.", "Я легко раздражаюсь, если не по-моему.", "Мне трудно придерживаться режима, целей, решений."]
		},
		{
		...
		{
			title: "Перфекционизм",
			questions: ["Я должна быть лучшей во всем, что я делаю, и не могу позволить быть в чем-то хуже других.", "Мне всегда важно выглядеть наилучшим образом.", "Я стараюсь держать почти все в идеальном порядке.", "У меня так много дел, что почти нет времени, чтобы по-настоящему расслабиться.", "Моя личная жизнь страдает, потому что я слишком требовательна к себе и другим.", "Я ничего не успеваю.", "Я не могу расслабиться и насладиться процессом, пока моя цель не достигнута.", "Мое здоровье страдает, потому что я испытываю сильное напряжение.", "Я стараюсь делать все как можно лучше и не приемлю, когда говорят, что «и так уже достаточно хорошо».", "Мне важно обладать деньгами, властью, достичь признания и быть намного статусней других."]
		},
		{
			title: "Надменность",
